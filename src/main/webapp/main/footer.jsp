...
<body class="u-body u-xl-mode" data-lang="en">
  <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-426a">
	<div class="u-clearfix u-sheet u-sheet-1">
	  <p class="u-align-left u-custom-font u-small-text u-text u-text-variant u-text-1">
       <span style="font-size: 1.2rem; font-weight: 800;" class="u-text-custom-color-1">Hong's Class&nbsp;</span>
       <br>대표 : 홍정훈 | 010-0000-0000<br>서울시 마포구 양화로 122 홍스클래스
	  </p>
        
	  <p class="u-align-right u-custom-font u-text-custom-color-2 u-text u-text-2"> Copyright ⓒ 2023 Hong's Class All Rights Reserved.</p>
	  ...
	  <div class="u-social-icons u-spacing-12 u-social-icons-1">
		...
		<a class="u-social-url" title="facebook" target="_blank" href="https://facebook.com/">
          <span class="u-icon u-social-facebook u-social-icon u-text-custom-color-2 u-icon-1">
            <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-268e"></use>
            </svg>
            <svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-268e">
		...
		<a class="u-social-url" title="twitter" target="_blank" href="https://twitter.com/">
		  <span class="u-icon u-social-icon u-social-twitter u-text-custom-color-2 u-icon-2">
		    <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
		      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-6143"></use>
		    </svg>
		    <svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-6143">
		...
		<a class="u-social-url" title="instagram" target="_blank" href="https://instagram.com/">
		  <span class="u-icon u-social-icon u-social-instagram u-text-custom-color-2 u-icon-3">
		    <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
		      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-a329"></use>
		    </svg>
		    <svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-a329">
		      <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
